...
public class StudentSettingService implements IStudentSetting {
    ...
    @Override
    public String authorizeStudent(String token) {
    ...
    @Override
    public String changeEmail(String token, String email) {
        if (isAuthorized(token)) {
    ...
    @Override
    public String checkActivationStatus(String token) {
        if (isAuthorized(token)) {
            String email = decoder.decodeToken(token);
            logger.log(Level.INFO, email);
    ...
    @Override
    public String changePhone(String token, String phone) {
        if (isAuthorized(token)) {
            String email = decoder.decodeToken(token);
            logger.log(Level.INFO, email);
