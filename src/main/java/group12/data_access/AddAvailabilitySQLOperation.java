...
public class AddAvailabilitySQLOperation extends SQLOperationTemplate {

    public AddAvailabilitySQLOperation(String email, String creditCardHolder, String creditCardNum, String creditCardExpiryDate, int securityCode) {
